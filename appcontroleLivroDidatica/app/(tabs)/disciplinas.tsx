...
export default function DisciplinasScreen() {
  const [disciplinas, setDisciplinas] = useState<Disciplina[]>([
    { id: '1', nome: 'Matemática', descricao: 'Álgebra, geometria e cálculo', cargaHoraria: '80', professor: 'Ana Silva' },
    { id: '2', nome: 'Português', descricao: 'Gramática e literatura', cargaHoraria: '80', professor: 'Carlos Oliveira' },
    { id: '3', nome: 'Ciências', descricao: 'Física, química e biologia', cargaHoraria: '60', professor: 'Mariana Santos' },
  ]);
    ...
    if (editando && disciplinaAtual) {
      ...
      novasDisciplinas = disciplinas.map(d => 
        d.id === disciplinaAtual.id 
          ? { ...d, nome, descricao, cargaHoraria, professor } 
          : d
      );
    } else {
  ...
  const renderItem = ({ item }: { item: Disciplina }) => (
    <View style={styles.card}>
      <View style={styles.cardContent}>
        ...
        <Text style={styles.cardSubtitle}>Professor(a): {item.professor}</Text>
      </View>
